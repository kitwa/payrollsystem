...
public class GetPayrollPeriodsHandler(IAppDbContext db) : IRequestHandler<GetPayrollPeriodsQuery, Result<List<PayrollPeriodDto>>>
{
...
public class GetPayrollPeriodByIdHandler(IAppDbContext db) : IRequestHandler<GetPayrollPeriodByIdQuery, Result<PayrollPeriodDto>>
{
...
public class GetPayrollPeriodLinesHandler(IAppDbContext db) : IRequestHandler<GetPayrollPeriodLinesQuery, Result<List<PayrollLineDto>>>
{
